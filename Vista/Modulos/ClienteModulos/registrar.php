...
<section class="form-register">
    ...
    <form name="controls" method="POST">
      ...
      <select class="controls" name="dep" id="selectDep" title="Seleccione un departamento" require>
      ...
      <select class="controls" name="municipio" id="selectMun" require>
        <option value="">Municipio*</option>
      </select>
      <input class="controls" type="email" name="correo" 
        pattern="^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$" 
        title="ejemplo123@email.com" id="correo" placeholder="Correo*" require>
      <input class="controls" type="password" name="pass" id="pass" placeholder="Contraseña*" 
      pattern="(?!^[0-9]*$)(?!^[a-zA-Z]*$)^([a-zA-Z0-9]{5,10})$" title="Mínimo 5 caracteres, con letras y numeros" require>
